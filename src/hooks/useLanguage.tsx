...
const translations = {
  ...
  profile: {
    ...
    paymentFooter: { es: "Pago y Pie de Factura", en: "Payment & Footer" },
    paymentFooterDesc: { es: "Información que aparece en el pie de cada factura", en: "Info shown in the footer of every invoice" },
    iban: { es: "IBAN (transferencia bancaria)", en: "IBAN (bank transfer)" },
    bizum: { es: "Bizum (número de teléfono)", en: "Bizum (phone number)" },
    paymentTerms: { es: "Condiciones de pago", en: "Payment terms" },
    paymentTermsPlaceholder: { es: "Ej: Pago a 15 días", en: "E.g. Net 15 days" },
    footerNote: { es: "Mensaje de cierre", en: "Closing note" },
    footerNotePlaceholder: { es: "Ej: Gracias por tu confianza", en: "E.g. Thank you for your business" },
  },
  expenses: {
